...
<div class="topnav" id="myTopnav">
  ...
  <a class="active" href="https://cpimentelguerra.com/chemobrionics/howtouse">How to use</a>
...
In this database, chemical gardens can be searched by anionic or cationic constituents. In addition, it can also be  searched the experimental setup used to promote the growth of chemical gardens.

Currently, the database is divided in 8 different setups, including natural chemical gardens.
